...
var  sql = 'SELECT * FROM '+_db+' WHERE keyword = "JS方法"';
...
function mod2(id) {
    var modSql = 'UPDATE '+_db+' SET keyword = ? WHERE Id = ?';
    var modSqlParams = ['JS内置对象',id];
...
// var data = xlsx.parse("./数据处理源文件/" + "javascript.xlsx");
...
function delCss() {
  // for (let i = 0; i < arr.length; i ++) {
    var delSql = 'DELETE FROM '+_db+' where keyword="DOM操作"';
